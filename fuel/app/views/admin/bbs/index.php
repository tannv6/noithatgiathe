<div class="mb-2 d-flex justify-content-between">
    <a class="btn btn-primary" href="/admin/bbs/write?category_code=<?=$category_code?>"> <i class="fa-solid fa-plus"></i> Thêm bài viết mới</a>
    <div>
        ...
        <tbody>
            <?php foreach ($result['data'] as $key => $bbs): ?>
                <tr>
                    ...
                    <td>
                        <input type="text" value="<?= $bbs->o_num ?>" name="o_num[]" data-id="<?=$bbs->bbs_id?>" class="form-control o_num" style="width: 60px">
                    </td>
                    <td>
                        <a class="btn btn-primary " href="<?= Uri::create('admin/bbs/write/' . $bbs->bbs_id) ?>?category_code=<?=$category_code?>">Sửa</a>
